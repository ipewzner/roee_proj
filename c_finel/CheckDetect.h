...
void CheckDetect(
    double* TracksX, double* TracksY, double* Tracksdlt_flag, double* TracksStat_id,
    int MinTracketLen, int numTracks, int trackLength,
    double* ReportTrackRange, int* DetectFlagVec) {
